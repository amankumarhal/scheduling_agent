...
class Settings(BaseSettings):
    ...
    cartesia_api_version: str = Field(default="2026-03-01", alias="CARTESIA_API_VERSION")
    cartesia_tts_model: str = Field(default="sonic-3.5", alias="CARTESIA_TTS_MODEL")
    cartesia_tts_voice_id: str = Field(default="694f9389-aac1-45b6-b726-9d9369183238", alias="CARTESIA_TTS_VOICE_ID")
