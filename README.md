...
This transcribes an audio file, sends the text to the agent, and generates a speech response. Live microphone streaming is intentionally not included in this first version.
...
- Voice mode accepts audio files only; real-time voice transport is deferred.
